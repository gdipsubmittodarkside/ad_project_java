...
public class RScheduleEventController {
    ...
    public ResponseEntity<ScheduleEvent> saveScheduleEvent(
    ...
    public ResponseEntity<Long> deleteScheduleEvent(
    ...
    public ResponseEntity<ScheduleEvent> getScheduleEventById(
            @PathVariable("id") Long id) {
