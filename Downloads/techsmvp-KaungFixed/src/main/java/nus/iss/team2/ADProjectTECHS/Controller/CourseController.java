...
public class CourseController {
    ...
    // public String FindCoursesBySkillTitle(@RequestParam String skillTitleEntered,
    // Model model){
    // List<CourseCrawled> courses =
    // courseCrawledService.findCoursesBySkillTitleLike(skillTitleEntered);
