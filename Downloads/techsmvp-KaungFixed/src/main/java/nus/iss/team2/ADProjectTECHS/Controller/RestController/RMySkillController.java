...
public class RMySkillController {
    ...
    public ResponseEntity<MySkill> saveMySkill(
            @RequestBody MySkill mySkill) {
    ...
    @PutMapping("/mySkills")
    public ResponseEntity<MySkill> updateMySkill(
            @RequestBody MySkill mySkill) {
    ...
    public ResponseEntity<Long> deleteMySkill(
    ...
    public ResponseEntity<MySkill> getMySkillById(
            @PathVariable("id") Long id) {
