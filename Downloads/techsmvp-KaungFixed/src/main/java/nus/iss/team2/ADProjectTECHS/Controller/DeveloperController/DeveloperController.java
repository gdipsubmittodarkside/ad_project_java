...
public class DeveloperController {
    ...
    public static List<String> jobList = Arrays.asList(
            "SQL DEVELOPER", "SOFTWARE DEVELOPER",
            "DATA ENGINEER", "DATA ARCHITECT",
            "FULL STACK DEVELOPER", "TECHNICAL CONSULTANT",
            "IT PROJECT EXECUTIVE", "Android DEVELOPER",
            "UI UX DESIGNER", "IOS DEVELOPER",
            "DEVOPS ENGINEER", "CLOUD SOLUTIONS ARCHITECT",
            "FRONTEND ENGINEER",
            "ARTIFICIAL INTELLIGENCE ENGINEER",
            "COMPUTER VISION ENGINEER", "SYSTEM ANALYST",
            "JAVA DEVELOPER", "DOT NET DEVELOPER");

    public static List<String> skillList = Arrays.asList(
            "HTML", "JavaScript", "SQL", "C plus plus",
            "Visual Basic", "CSS", "Spring boot framework",
            "Angular", "Data Analysis Expressions",
            "Azure Cloud", "Java", "Talend",
            "Azure Data Lake", "Devpos", "ReactJS",
            "Amazon EC2", "Tableau", "C sharp", "Docker",
            "Kubernetes", "Kotlin", "vue.js", "Redis",
            "Spark Framework", "Grafana",
            "OAuth security framework", "Flutter", "Figma",
            "Swift", "Perl", "XML", "Bash", "Python",
            "MongoDB", "VB .NET", "J2ee", "Terraform",
            "Ruby", "Groovy", "Ubuntu", "Debian", "Git",
            "PHP", "ASP.NET", "Redux", "Express",
            "Bootstrap", "OPENAPI", "Linux", "PostgreSQL",
            "Ruby on Rails", "Flask", "Django",
            "Objective C", "Nginx", "jQuery", "Apache",
            "Node.js", "Redshift", "Snowflake", "Laravel",
            "Emberjs", "Backbonejs", "Matlab", "TypeScript",
            "Scala", "Rust", "Go", "Android Studio",
            "Neural Network Models", "Machine Learning",
            "Amazon S3", "AWS Aurora", "Amazon DynamoDB",
            "Amazon RDB", "Amazon Lambda", "Amazon VPC",
            "Natural Language Processing", "HQL", "PyTorch",
            "Tensorflow", "MindSpore", "Drupal", "Ether.js",
            "Unity", "FastAPI");

    public static List<String> skillDescList = Arrays
            .asList("HTML (HyperText Markup Language) is a standard markup language for web page creation. It allows the creation and structure of sections, paragraphs, and links using HTML elements (the building blocks of a web page) such as tags and attributes.",
                    ...
                    "vue.js", "Redis", "Spark Framework",
                    "Grafana", "OAuth security framework",
                    "Flutter",
                    ...
                    "Groovy", "Ubuntu", "Debian", "Git",
                    "PHP (Hypertext Preprocessor) is a widely-used open source general-purpose scripting language that is especially suited for web development and can be embedded into HTML.",
                    "ASP Dot NET", "Redux", "Express",
                    "Bootstrap", "OPENAPI",
                    ...
                    "PostgreSQL", "Ruby on Rails", "Flask",
                    "Django",
                    ...
                    "Apache", "Node.js", "Redshift",
                    "Snowflake", "Laravel", "Emberjs",
                    "Backbonejs",
                    ...
                    "Amazon S3", "AWS Aurora",
                    "Amazon DynamoDB", "Amazon RDB",
                    "Amazon Lambda", "Amazon VPC",
                    "Natural Language Processing", "HQL",
                    "PyTorch",
                    ...
                    "MindSpore", "Drupal", "Ether.js",
                    "Unity", "FastAPI");

    public static List<String> skillURLList = Arrays.asList(
            "ok-plXXHlWw", "UU-GebNqdbg", "27axs9dO7AE",
            "MNeX4EGtR5Y", "XXX Visual Basic",
            "OEV8gMkCHXQ", "XXX Spring boot framework",
            "Ata9cSC2WpM", "XXX Data Analysis Expressions",
            "XXX Azure Cloud", "l9AzO1FMgM8", "XXX Talend",
            "XXX Azure Data Lake", "scEDHsr3APg",
            "Tn6-PIqc4UM", "XXX Amazon EC2", "7Jl-RwkzqQ4",
            "ravLFzIguCM", "Gjnup-PuquQ", "PziYflu8cB8",
            "xT8oP0wy-A0", "nhBVL41-_Cw", "G1rOthIU-uo",
            "XXX Spark Framework", "XXX Grafana",
            "Cx2dkpBxst8 OAuth security framework",
            "Flutter", "Cx2dkpBxst8", "nAchMctX4YA",
            "74_7LrRe5DI", "XXX XML", "I4EWvMFj37g",
            "x7X9w_GIm1s", "-bt_y4Loofg", "XXX VB .NET",
            "XXX J2ee", "tomUWcQ0P3k", "XXX Ruby",
            "XXX Groovy", "XXX Ubuntu", "XXX Debian",
            "XXX Git", "a7_WFUlFS94", "XXX ASP DOT NET",
            "shA5Xwe8_4", "XXX Express", "XXX Bootstrap",
            "XXX OPENAPI", "rrB13utjYV4", "XXX PostgreSQL",
            "XXX Ruby on Rails", "XXX Flask", "XXX Django",
            "VmrpCi1XCvg", "XXX Nginx", "XXX jQuery",
            "XXX Apache", "XXX Node.js", "XXX Redshift",
            "XXX Snowflake", "XXX Laravel", "XXX Emberjs",
            "XXX Backbonejs", "XXX Matlab", "zQnBQ4tB3ZA",
            "XXX Scala", "5C_HPTJg5ek", "446E-r0rXHI",
            "XXX Android Studio",
            "XXX Neural Network Models", "PeMlggyqz0Y",
            "XXX Amazon S3", "XXX AWS Aurora",
            "XXX Amazon DynamoDB", "XXX Amazon RDB",
            "XXX Amazon Lambda", "XXX Amazon VPC",
            "XXX Natural Language Processing", "XXX HQL",
            "XXX PyTorch", "i8NETqtGHms", "XXX MindSpore",
            "XXX Drupal", "XXX Ether.js", "iqlH4okiQqg",
            "XXX FastAPI");
    ...
    public String pythonCallAllJobs(
        ...
        for (String job : jobList) {
            try {
                ...
                result = pythonAPIService
                        .getAPIJobData(keyword);
            } catch (Exception e) {
    ...
    public String pythonCallAllCourses(
            @PathVariable String password, Model model) {
        String result = "";
        String skills = "";
        int count = 0;
        ...
        result += ", Total Skill update = " + count
                + ", skills' name => " + skills;
        model.addAttribute("result", result);
        System.out.println(result);
        return "DBResult";
    ...
    public String pythonCallCourse(
            @PathVariable String keyword, Model model) {
        String result = "";
        try {
            result = pythonAPIService
                    .getAPICourseData(keyword);
            model.addAttribute("result", result);
            System.out.println(result);
            return "DBResult";
        } catch (Exception e) {
