...
public class MemberController {
    /*
     * Includes: 1. login 2. logout 3. sign up 4. updateMember
     */
    ...
    public String registerMemberAccount(
            @ModelAttribute("newMember") @Valid Member newMember,
            ...
            if (skillsIds.size() > 0) {
                ...
                for (int i = 0; i < skillsIds.size(); i++) {
                    ...
                    if (mySkillService
                        ...
                        if (newMember
                                .getMySkills() == null) {
                            newMember.setMySkills(
                                    new ArrayList<MySkill>());
                            newMember.getMySkills()
                                    .add(mySkill);
                        } else {
                            newMember.getMySkills()
                                    .add(mySkill);
    ...
    @ResponseBody
    public void setDreamJob(
            @PathVariable String newDreamJobId) {
        ...
        Job dreamJob = jobService
                .findJobById(Long.parseLong(newDreamJobId));
    ...
    public String updateNoti() {
        ...
        if (currentMember.getNotification()
                .equalsIgnoreCase("on")) {
