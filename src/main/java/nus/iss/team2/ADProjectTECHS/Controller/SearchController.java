...
public class SearchController {
    ...
    public String getSearchResult(@RequestParam(value="skill") String skill, @RequestParam(value="sort") String sort, Model model){
        ...
        if(sort.equals("like")){
            courseCrawledList = courseCrawledService.findCCByOrderByLikes(skill1.getSkillId());
        }

        if(sort.equals("view")){
            courseCrawledList = courseCrawledService.findCCByOrderByViews(skill1.getSkillId());
        }

        if(sort.equals("subscribe")){
            courseCrawledList = courseCrawledService.findCCByOrderBySubscribers(skill1.getSkillId());
        }

        if(sort.equals("date")){
            courseCrawledList = courseCrawledService.findCCByOrderByDate(skill1.getSkillId());
        }
