...
public class CourseCrawledServiceImpl implements CourseCrawledService {
    ...
    @Override
    public List<CourseCrawled> findCCByOrderByLikes(long skillId) {
        return courseCrawledRepository.findCCByOrderByLikes(skillId);
    }

    @Override
    public List<CourseCrawled> findCCByOrderByViews(long skillId) {
        return courseCrawledRepository.findCCByOrderByViews(skillId);
    }

    @Override
    public List<CourseCrawled> findCCByOrderByDate(long skillId) {
        return courseCrawledRepository.findCCByOrderByDate(skillId);
    }

    @Override
    public List<CourseCrawled> findCCByOrderBySubscribers(long skillId) {
        return courseCrawledRepository.findCCByOrderBySubscribers(skillId);
    }
