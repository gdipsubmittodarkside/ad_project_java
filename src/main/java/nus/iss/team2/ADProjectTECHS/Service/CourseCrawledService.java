...
public interface CourseCrawledService {
    ...
    List<CourseCrawled> findCCByOrderByLikes(long skillId);
    List<CourseCrawled> findCCByOrderByViews(long skillId);
    List<CourseCrawled> findCCByOrderByDate(long skillId);
    List<CourseCrawled> findCCByOrderBySubscribers(long skillId);
